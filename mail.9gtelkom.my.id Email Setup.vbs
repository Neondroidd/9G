' mail.9gtelkom.my.id Email Setup.vbs
'
...
' *************************************************************************
strIncServerAddress	   = "mail.9gtelkom.my.id"		 					' This is the address for the mail server
strOutServerAddress	   = "mail.9gtelkom.my.id"		 					' This is the address for the mail server
...
strAccount			   = "admin@9gtelkom.my.id"							' Mail account to connect as
